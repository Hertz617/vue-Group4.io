  ...
  <el-dialog v-model="dialogFormVisible" title="论文编辑">
    <el-form :model="Paper">
      ...
      <el-form-item label="刊物种类" :label-width="formLabelWidth">
        ...
        <el-select v-model="Paper.publicationCate" placeholder="请选择刊物种类" autocomplete="off">
          <el-option label="核心期刊" value="核心期刊"></el-option>
          <el-option label="国际会议" value=" 国际会议"></el-option>
          <el-option label="SCI" value="SCI"></el-option>
          <el-option label="EI" value="EI"></el-option>
          <el-option label="本科学报" value="本科学报"></el-option>
        </el-select>
      </el-form-item>
      ...
      <el-form-item label="论文类型" :label-width="formLabelWidth">
        ...
        <el-select v-model="Paper.type" placeholder="请选择论文类型" autocomplete="off">
